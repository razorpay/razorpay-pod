...
final public class SwiftColorPickerViewController: UIViewController
{
    ...
    public override func viewDidLoad() {
        ...
        let tapGr = UITapGestureRecognizer(target: self, action: #selector(SwiftColorPickerViewController.handleGestureRecognizer(recognizer:)))
        let panGr = UIPanGestureRecognizer(target: self, action: #selector(SwiftColorPickerViewController.handleGestureRecognizer(recognizer:)))

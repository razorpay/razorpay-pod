...
@class NSString;
@class NSObject;
SWIFT_PROTOCOL("_TtP16RazorpayStandard31ExternalWalletSelectionProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard20MagicXResultProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard21PluginPaymentDelegate_")
...
SWIFT_CLASS("_TtC16RazorpayStandard18PluginPaymentModel")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard16RazorpayProtocol_")
@protocol RazorpayProtocol
@end

SWIFT_PROTOCOL("_TtP16RazorpayStandard33RazorpayPaymentCompletionProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard41RazorpayPaymentCompletionProtocolWithData_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard22RazorpayResultProtocol_")
@protocol RazorpayResultProtocol <RazorpayProtocol>
- (void)onCompleteWithResponse:(NSDictionary * _Nonnull)response;
@end

SWIFT_CLASS("_TtC16RazorpayStandard7Session")
@interface Session : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_PROTOCOL("_TtP16RazorpayStandard11TokenPlugin_")
@protocol TokenPlugin
- (void)initialize:(id _Nonnull)delegate;
@end

SWIFT_PROTOCOL("_TtP16RazorpayStandard34UPITurboLinkedBankAccountsProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard33UPITurboLinkedUpiAccountsProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard24UPITurboPrefetchProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard14UPITurboPlugin_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard30UPITurboPrefetchWithUIProtocol_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard17UPITurboTPVPlugin_")
@protocol UPITurboTPVPlugin
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard19UPITurboTPVUIPlugin_")
...
SWIFT_PROTOCOL("_TtP16RazorpayStandard16UPITurboUIPlugin_")
